...
const results = loadouts.map(loadoutId => {
    ...
    return {
        ...
        summary: {
            ...
            avgTurnEndSparkRatio: summary.pacingSignal.avgTurnEndSparkRatio,
            preservedRestedTurns: summary.pacingSignal.preservedRestedTurns,
            restedBatterySpendSelections: summary.pacingSignal.restedBatterySpendSelections,
            trueRestRestedBonusArmedTurns: summary.pacingSignal.trueRestRestedBonusArmedTurns,
            voluntaryExhaustionAllowed: summary.pacingSignal.voluntaryExhaustionAllowed,
            turnsEndedStableOrBetter: summary.pacingSignal.turnsEndedStableOrBetter,
            turnsEndedCriticalOrExhausted: summary.pacingSignal.turnsEndedCriticalOrExhausted,
            ...
            avgEnemyIdleWithVisiblePlayer: summary.enemyAiTelemetry.avgEnemyIdleWithVisiblePlayer,
            avgEnemyTurnsEndedStableOrBetter: summary.enemyAiTelemetry.avgEnemyTurnsEndedStableOrBetter,
            avgEnemyTurnsEndedCriticalOrExhausted: summary.enemyAiTelemetry.avgEnemyTurnsEndedCriticalOrExhausted
        },
        guardrails,
        breaches: breached,
        waived,
